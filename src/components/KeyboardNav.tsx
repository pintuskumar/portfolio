        ...
        {showHint && (
          <>
            ...
            <motion.div
              ...
              className="fixed top-1/2 left-1/2 -translate-x-1/2 -translate-y-1/2 z-[50000] w-80 rounded-2xl border border-white/10 bg-gray-950/95 p-6 shadow-2xl backdrop-blur-xl"
            >
